...
public class PluginHelper implements ServiceConnection {
    ...
    private void initPlugin(Context baseContext) {
        ...
        try {
            try {
                ...
                LogUtils.e(TAG, "fixMiUiLbeSecurity has error", e);
            }
            ...
            try {
                ...
                LogUtils.e(TAG, "installHook has error", e);
            }
            ...
            try {
                ...
                LogUtils.e(TAG, "setHookEnable has error", e);
            }
            ...
            LogUtils.i(TAG, "Init plugin in process cost %s ms", (System.currentTimeMillis() - b));
        }
    }
    ...
    private void fixMiUiLbeSecurity() throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        if (Looper.getMainLooper() == Looper.myLooper()) {
            ...
            try {
                ...
                LogUtils.e(TAG, "getMainLooper MessageQueue.IdleHandler:" + mMessages);
            } catch (Exception e) {
                LogUtils.e(TAG, "fixMiUiLbeSecurity:error on remove lbe message", e);
            }
        }
    }
    ...
    private void findLbeMessageAndRemoveIt(Message message) {
        ...
        try {
            ...
            LogUtils.e(TAG, "findLbeMessageAndRemoveIt:error on remove lbe message", e);
        }
