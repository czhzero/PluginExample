...
public class PluginInstrumentation extends Instrumentation {
    ...
    public void callActivityOnCreate(Activity activity, Bundle icicle) {
        ...
        LogUtils.d(TAG, "PluginInstrumentation callActivityOnCreate");
        ...
        if (enable) {
            ...
            try {
                ...
                LogUtils.e(TAG, "callActivityOnCreate:fakeSystemService", e);
            }
            try {
                onActivityCreated(activity);
            } catch (RemoteException e) {
                LogUtils.e(TAG, "callActivityOnCreate:onActivityCreated", e);
            }

            try {
                fixBaseContextImplOpsPackage(activity.getBaseContext());
            } catch (Exception e) {
                LogUtils.e(TAG, "callActivityOnCreate:fixBaseContextImplOpsPackage", e);
            }

            try {
                fixBaseContextImplContentResolverOpsPackage(activity.getBaseContext());
            } catch (Exception e) {
                LogUtils.e(TAG, "callActivityOnCreate:fixBaseContextImplContentResolverOpsPackage", e);
            }
            ...
            if (mOpPackageName != null) {
                ...
                if (valueObj instanceof String) {
                    ...
                    if (!TextUtils.equals(opPackageName, mHostContext.getPackageName())) {
                        ...
                        LogUtils.i(TAG, "fixBaseContextImplOpsPackage OK!Context=%s,", baseContext);
                    }
                }
            }
        }
                ...
                if (valueObj instanceof ContentResolver) {
                    ...
                    if (mPackageNameValueObj != null && mPackageNameValueObj instanceof String) {
                        ...
                        if (!TextUtils.equals(packageName, mHostContext.getPackageName())) {
                            ...
                            LogUtils.i(TAG, "fixBaseContextImplContentResolverOpsPackage OK!Context=%s,contentResolver=%s", baseContext, contentResolver);
                        }
                    }
    ...
    private void onActivityCreated(Activity activity) throws RemoteException {
        try {
            ...
            LogUtils.i(TAG, "onActivityCreated fail", e);
        }
    }
    ...
    private void fixTaskDescription(Activity activity, ActivityInfo targetInfo) {
        try {
            ...
            LogUtils.w(TAG, "fixTaskDescription fail", e);
        }
    }
    ...
    public void callActivityOnDestroy(Activity activity) {
        ...
        if (enable) {
            try {
                ...
                LogUtils.e(TAG, "callActivityOnDestroy:onActivityDestory", e);
            }
        }
    }
    ...
    public void callApplicationOnCreate(Application app) {
        if (enable) {
            ...
            try {
                ...
                LogUtils.e(TAG, "fakeSystemService", e);
            }

            try {
                fixBaseContextImplOpsPackage(app.getBaseContext());
            } catch (Exception e) {
                LogUtils.e(TAG, "callApplicationOnCreate:fixBaseContextImplOpsPackage", e);
            }
        ...
        try {
            ...
            LogUtils.e(TAG, "onCallApplicationOnCreate", e);
        }
        ...
        if (enable) {
            try {
                ...
                LogUtils.e(TAG, "registerStaticReceiver", e);
            }
        }
    }
...
//        }
        try {
            ...
            LogUtils.e(TAG, "callActivityOnNewIntent:read EXTRA_TARGET_INTENT", e);
        }
        if (enable) {
            try {
                onActivityOnNewIntent(activity, intent);
            } catch (RemoteException e) {
                LogUtils.e(TAG, "callActivityOnNewIntent:onActivityOnNewIntent", e);
            }
        }
        if (mTarget != null) {
