                ...
                if (activityInfo != null && isPackagePlugin(activityInfo.packageName)) {
                    ...
                    if (component != null) {
                        ...
                        try {
                            ...
                            LogUtils.w(TAG, "Set Class Loader to new Intent fail", e);
                        }
                        newIntent.setComponent(component);
                        newIntent.putExtra(PluginConstant.EXTRA_TARGET_INTENT, intent);
...
//                        }
                        ...
                        LogUtils.w(TAG, "startActivity,replace selectProxyActivity fail");
                    }
                }
            }
...
//                        } catch (Exception e) {
//                            LogUtils.e(TAG, "invokeMethod connected", e);
//                        }
//                    }
//                };
//            }
       ...
       /* public int startActivities(IApplicationThread caller, String callingPackage,
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                ...
                if (args != null && args.length > index && args[index] instanceof String) {
                    ...
                    LogUtils.w(TAG, "hook startActivities,replace callingPackage fail");
                }
                ...
                if (args != null && args.length > index && args[index] != null && args[index] instanceof Intent[]) {
                    ...
                    LogUtils.w(TAG, "hook startActivities,replace intents fail");
                }
