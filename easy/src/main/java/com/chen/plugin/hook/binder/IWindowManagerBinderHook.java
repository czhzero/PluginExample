...
import com.chen.plugin.utils.compat.IWindowManagerCompat;
...
public class IWindowManagerBinderHook extends BinderHook {
    ...
    protected void onInstall(ClassLoader classLoader) throws Throwable {
        ...
        try {
            ...
            LogUtils.w(TAG, "onInstall writeStaticField to sWindowManager fail", e);
        }
    }
    ...
    public static void fixWindowManagerHook(Activity activity) {
        try {
            ...
            LogUtils.w(TAG, "fixWindowManagerHook writeStaticField to sWindowManager fail", e);
        }
