...
import com.chen.easyplugin.stub.ActivityStub;
...
//Extra
    ...
    public static Intent getActivityStubIntent(Intent intent) {
        ...
        if (componentName != null) {
            ...
            bundle = PluginManager.getInstance().getBundleByPackageName(packageName);
        }
        if (bundle != null) {
    ...
    public static Intent changeToPluginIntent(Intent intent, String className) {
        ...
        ComponentName componentName = intent.getComponent();
        if (componentName != null) {
            stubIntent.setClassName(PluginManager.getInstance().getHostContext(), className);
...
//			stubIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public static Intent changeToSingleTaskPluginIntent(Intent intent) {
        ...
        ComponentName componentName = intent.getComponent();
        if (componentName != null) {
            PluginManager bundleManager = PluginManager.getInstance();
    ...
    public static Intent changeToPluginServiceIntent(Intent intent) {
        ...
        if (componentName != null) {
            ...
            proxyIntent.setClassName(PluginManager.getInstance().getHostContext(), className);
    ...
    public static String getDefaultBundleFilePath() {
        Context context = PluginManager.getInstance().getHostContext();
    ...
    public static PluginInfo copyNewBundleInfo(PluginInfo info) {
        ...
        result.setPluginPath(info.getPluginPath());
