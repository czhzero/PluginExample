...
public class PluginModule {
    ...
    public PluginModule(Context context, String apkPath,
        ...
        this.activityThread = PluginManager.getInstance().getActivityThread();
    ...
    private void makeApplication() {
        ...
        try {
            ...
            if (base != null) {
                ...
                PluginContextWrapper newBase = new PluginContextWrapper(base);
